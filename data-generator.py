...
# ===== Generator-OCT-data =====
def main(delta_min, delta_max, amount_of_delta):
    # ===== Delta grid =====
    numeric_array = np.linspace(delta_min, delta_max, amount_of_delta)
    ...
    wl_new = np.linspace(wl.min(), wl.max(), 10 * len(wl))
...
if __name__ == "__main__":
    ...
    delta_max = 100
    amount_of_delta = 500
    main(delta_min, delta_max, amount_of_delta)
